	...
	<div class="container container-web-page">
	    ...
	    <div class="container-cards full-box" style="padding-bottom: 40px;">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre6.webp" alt="nombre_platillo">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre1.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre2.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre3.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre4.png" alt="nombre_platillo">
	            <div class="card-body text-center">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/postre5.png" alt="nombre_platillo">
	            <div class="card-body text-center">
