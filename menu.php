...
<body>
	...
	<div class="container container-web-page">
	    ...
	    <p class="text-justify">Bienvenido al menú de platillos, acá encontrara todos los platillos disponibles en el restaurante. Puede ordenar los platillos por categoría en el botón " MENÚ"</p>
	    ...
	    <div class="container-cards full-box" style="padding-bottom: 40px;">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida1.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">ARROZ CON POLLO</h5>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida2.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">CEVICHE</h5>
	                <p class="card-text lead"><span class="badge bg-secondary">30.00 SOLES</span></p>
	            </div>
	            <div class="card-body text-center">
	                <a href="details.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Detalles</a>
	            </div>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida3.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">AJI DE GALLINA</h5>
	                <p class="card-text lead"><span class="badge bg-secondary">25.00 SOLES</span></p>
	            </div>
	            <div class="card-body text-center">
	                <a href="details.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Detalles</a>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida4.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">CAUSA RELLENA</h5>
	                <p class="card-text lead"><span class="badge bg-secondary">15.00 SOLES</span></p>
	            </div>
	            <div class="card-body text-center">
	                <a href="details.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Detalles</a>
	            </div>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida5.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">Lomo Saltado</h5>
	                <p class="card-text lead"><span class="badge bg-secondary">25.00 SOLES</span></p>
	            </div>
	            <div class="card-body text-center">
	                <a href="details.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Detalles</a>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./imagenes/comida6.jpg" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">ROCOTO RELLENO</h5>
	                <p class="card-text lead"><span class="badge bg-secondary">25.00 SOLES</span></p>
	            </div>
	            <div class="card-body text-center">
	                <a href="details.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Detalles</a>
